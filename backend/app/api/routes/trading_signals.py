...
from app.api.dependencies import get_current_user_id, require_authorized_role
from app.services.database import get_db
from app.models.trading_signal import TradingSignal
from app.schemas.trading_signal import TradingSignalResponse, TradingSignalList

router = APIRouter(prefix="/trading-signals", tags=["trading-signals"], dependencies=[Depends(require_authorized_role)])
